...
void ImGui::RenderTextWrapped(ImVec2 pos, const char* text, const char* text_end, float wrap_width)
{
    ...
    if (text != text_end)
    {
        ...
        float fFontSize = g.FontSize;

        //if(ImGui::GetStyle().Alpha > 0.4f)
        {
            pos.x -= iOffset;
            window->DrawList->AddText(g.Font, fFontSize, pos, GetColorU32(0xFF000000), text, text_end, wrap_width);
            pos.x += iOffset;
            // right 
            pos.x += iOffset;
            window->DrawList->AddText(g.Font, fFontSize, pos, GetColorU32(0xFF000000), text, text_end, wrap_width);
        ...
        window->DrawList->AddText(g.Font, fFontSize, pos, GetColorU32(ImGuiCol_Text), text, text_end, wrap_width);
...
void ImGui::UpdateMouseWheel()
{
    ...
    if ((g.IO.MouseWheel != 0.0f || g.IO.MouseWheelH != 0.0f) && !g.IO.KeyCtrl)
    {
